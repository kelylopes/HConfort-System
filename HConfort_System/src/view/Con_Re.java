 ...
 */
public class Con_Re extends javax.swing.JFrame {

    /**
     * Creates new form Con_Re
     */
    public Con_Re() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Con_Re.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
